...
public interface ObserverDataRepository extends JpaRepository<ObserverData, ObserverDataKey> {
    @Query("select distinct function('to_char', o.observerDataKey.dataTime, 'YYYY.MM.DD HH24:00') as datetime from ObserverData o where o.observerDataKey.dataTime is not null")
