...
public interface SDoTDataRepository extends JpaRepository<SDoTData, SDoTDataKey> {
    @Query("select distinct function('to_char', function('to_timestamp', s.sDoTDataKey.registTime, 'YYYY-MM-DD HH24:MI'), 'YYYY.MM.DD HH24:00') as datetime from SDoTData s where s.sDoTDataKey.registTime is not null")
