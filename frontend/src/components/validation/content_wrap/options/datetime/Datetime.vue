    ...
    export default {
        ...
        computed: {
            ...mapState({
                ...
                dateTypes: state => state.validation.dateTypes,
                selectedDateType: state => state.validation.selectedDateType,
                available: state => state.validation[state.validation.selectedCategory].available
            })
        },
        methods: {
            ...mapActions({
                setStartDatetime: "SET_VALIDATION_START_DATETIME",
                setEndDatetime: "SET_VALIDATION_END_DATETIME",
                setSelectedDateType: "SET_VALIDATION_SELECTED_DATE_TYPE"
            }),
