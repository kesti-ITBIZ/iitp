    ...
    export default {
        ...
        computed: {
            ...mapState({
                ...
                searchOptions: state => state.validation.searchOptions,
        ...
        methods: {
            ...mapActions({
                setSelectedSearchOption: "SET_VALIDATION_SELECTED_SEARCH_OPTION",
                setSelectedCategory: "SET_VALIDATION_SELECTED_CATEGORY"
            })
        }
    }
</script>
