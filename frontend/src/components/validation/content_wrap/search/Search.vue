    ...
    export default {
        ...
        computed: {
            ...mapState({
                ...
                searchedStations: state => state.validation.searchedStations
            })
        },
        watch: {
            windowWidth() {
        ...
        methods: {
            ...mapActions({
                setSearchedStations: "SET_VALIDATION_SEARCHED_STATIONS",
                appendSearchedStations: "APPEND_VALIDATION_SEARCHED_STATIONS",
